...
epsilon_w182_100ma_dict['silicate']['epsilon_182w'].append(eucrite)
epsilon_w182_100ma_dict['silicate']['name'].append("Eucrite")
...
#     y_val += 2
# for index, i in enumerate(epsilon_w182_5ma_dict['silicate']['epsilon_182w']):
#     epsilon = epsilon_w182_5ma_dict['silicate']['epsilon_182w'][index]
#     name = epsilon_w182_5ma_dict['silicate']['name'][index]
...
bax2 = brokenaxes(xlims=((-10000, -8800), (-4000, 1200)), hspace=.0005, despine=False, d=0.01)
for index, i in enumerate(epsilon_w182_100ma_dict['core']['epsilon_182w']):
    ...
    y_val_2 += 2
for index, i in enumerate(epsilon_w182_100ma_dict['silicate']['epsilon_182w']):
    epsilon = epsilon_w182_100ma_dict['silicate']['epsilon_182w'][index]
    name = epsilon_w182_100ma_dict['silicate']['name'][index]
    if "IW" in name:
...
bax2.set_title("$\epsilon$$^{182}$W At Infinite Time")
