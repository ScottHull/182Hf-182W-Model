...
while m.time < max_modeling_time:
    ...
    core_fraction.append(m.core_fraction_at_time)
...
ax6.plot([i / (10**6) for i in time_range], core_fraction, linewidth=2.0, color='black')
ax6.axvline(5, linewidth=2.0, color='red', linestyle="--", label='Max Core Growth Time')
ax6.grid()
ax6.set_xlabel("Time (Ma)")
ax6.set_ylabel("Core Mass Fraction")
ax6.set_title("Exponential Core Growth on Vesta")
